...
class Config {
    ...
    public function __constructor($post){
        ...
        $this->smtp['use'] =            (string)$conf->smtp->use;
        $this->smtp['auth'] =           (string)$conf->smtp->auth;
        $this->smtp['secure'] =         (string)$conf->smtp->secure;
        $this->smtp['host'] =           (string)$conf->smtp->host;
        $this->smtp['username'] =       (string)$conf->smtp->username;
        $this->smtp['password'] =       (string)$conf->smtp->password;
        $this->smtp['port'] =           (string)$conf->smtp->port;
        $this->charset =                (string)$conf->charset;
    }
